...
# Matching single regex out of several regex -- OR -> |
...
of the vertical bar). We must use parentheses to limit the use of alternations.
"""
...
- The rest of the string must contain only one or more English alphabetic letters 
    (upper and lowercase).
"""
...
match = re.match(pattern, "Mr.Teacher") is not None
match2 = re.match(pattern, "Sir.John") is not None
